...
class Jabberjay:
    ...
    def detect(self, audio: tuple[np.ndarray, float], model: Model, visualisation: Visualisation | None = None,
        ...
        match model:
            ...
            case Model.VIT:
                self.vit_handler(audio=audio, visualisation=visualisation, dataset=dataset)
    ...
    def vit_handler(self, audio: tuple[np.ndarray, float], visualisation: Visualisation, dataset: Dataset) -> None:
...
if __name__ == '__main__':
    ...
    parser.add_argument("-m", "--model", type=Model, action=EnumAction, default=Model.VIT)
    parser.add_argument('-d', "--dataset", type=Dataset, action=EnumAction, default=Dataset.VoxCelebSpoof)
    parser.add_argument('-vis', "--visualisation", type=Visualisation, action=EnumAction,
    ...
    jabberjay = Jabberjay()
    jabberjay.detect(audio=jabberjay.load(args.filename), model=args.model, visualisation=args.visualisation,
